...
offs = [70; 0]
ax = Axis(f[1, 1]; xlabel = "Protein",  ylabel = "Nb. observations", yticks = (offs, ["Train"; "Test"]))
...
ax = Axis(f[1, 1]; xticks = (0:1, ["Train", "Test"]), ylabel = "Protein")
rainclouds!(ax, test, y; clouds = hist, markersize = 2, color = cols, gap = .3)
f
